  ...
  return (
    <header className="sticky top-0 bg-white">
      <div className="flex w-full p-6 items-center">
        ...
        <Avatar
          className="ml-auto"
          url="https://lh3.googleusercontent.com/gjAVFqYqfe2oKBNEpjIwqN_pviLkoy2ZQARwVQQtG-bTxWe3HFBJoL1_Ly3xesobbK-TGJY5KX7o8Yn2ebtmnZHzWOc_2w0EWhXaXEmTM9OXJNExxQ"
        />
      </div>
      <HeaderOptions />
    </header>
